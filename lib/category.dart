import 'dart:convert';
import 'package:arne_news/homepage.dart';
...
class _CategoryState extends State<Category> {
  ...
  getNewsByQuery(String query) async {
    ...
    if(query == "Top News" || query == "India"){
      url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=81e6c35d67034da283417bc9302ca248";

    }else{
      url ="https://newsapi.org/v2/everything?q=$query&from=2021-06-28&sortBy=publishedAt&apiKey=81e6c35d67034da283417bc9302ca248";
    }
